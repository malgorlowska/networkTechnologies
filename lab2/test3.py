...
from main import generatePacketFlowMatrix, test3, addingCapacity
...
packageDelayMax = 0.03  # Tmax dopuszczalne opóźnienie pakietu

packetFlowMatrix = generatePacketFlowMatrix(G, N)
capacity = addingCapacity(G, packetFlowMatrix, 1.5, mediumPackageSize)
y, x = test3(G,N,capacity,mediumPackageSize,packageDelayMax,reliabilityOfEdge)
plt.plot(x,y)
plt.xlabel('the number of new edges, m = 12000 bit, p = 0.98, Tmax = 0.03, capacity parameter = 1.5 ')
