...
from main import generatePacketFlowMatrix, test2
...
packageDelayMax = 0.01  # Tmax dopuszczalne opóźnienie pakietu

packetFlowMatrix = generatePacketFlowMatrix(G, N)

y, x = test2(G,N,mediumPackageSize,packageDelayMax,reliabilityOfEdge)
plt.plot(x,y)
plt.xlabel('added capacity, m = 12000 bit, p = 0.98, Tmax = 0.01, capacity parameter = 2 ')
